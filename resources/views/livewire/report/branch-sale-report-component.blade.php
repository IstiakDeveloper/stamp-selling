<div class="p-6 bg-white shadow-lg rounded-lg">
    <form wire:submit.prevent="generateReport" class="space-y-4">
        <div class="flex gap-4 items-center">
            ...
            <div>
                <input type="date" id="specificDate" wire:model="specificDate" class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <div>
